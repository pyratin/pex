...
const gridStrokeStyleDefinition = /** @type {pixiJs.StrokeStyle} */ ({
  width: 1,
  color: 0x222222
});
          ...
          <pixiGraphics
            ...
            draw={(graphics) => {
              ...
              graphics
                .moveTo(x, 0)
                .lineTo(x, height)
                .stroke(gridStrokeStyleDefinition);
            }}
          />
        )
      )}
...
const transformOriginIntialized = Object.values(dimension).map(
  (value) => value / 2
);
  ...
  return (
    <div className={style.Control}>
      ...
      <button
        ...
        onClick={() => transformOriginSet(transformOriginIntialized)}
      >
        Reset
      </button>
    </div>
...
const Home = () => {
  ...
  useEffect(() => {
    ...
    Object.assign(
      refCurrentLayoutContainer.getChildByLabel('OriginMarker'),
      /** @type {pixiJs.ContainerOptions} */ ({
