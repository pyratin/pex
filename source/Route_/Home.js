  ...
  return (
    <pixiGraphics
      draw={(graphics) => {
        ...
        graphics.stroke({ color: 0x444444 });
      }}
    />
  );
};
...
const transformOriginInitialized = Object.values(dimension).map(
  (value) => value / 2
);
  ...
  return (
    <div className={style.Control}>
      ...
      <button
        ...
        onClick={() => transformOriginSet(transformOriginInitialized)}
      >
        Reset
      </button>
    </div>
